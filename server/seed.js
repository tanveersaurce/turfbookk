...
const seed = async () => {
  try {
    ...
    const turf1 = await Turf.create({
      ...
      mapsLink: 'https://maps.app.goo.gl/seedTurf1',
    ...
    const turf2 = await Turf.create({
      ...
      city: 'Bhopal',
      area: 'MP Nagar',
      mapsLink: 'https://maps.app.goo.gl/seedTurf2',
    ...
    const turf3 = await Turf.create({
      ...
      city: 'Mumbai',
      area: 'Bandra',
      mapsLink: 'https://maps.app.goo.gl/seedTurf3',
    ...
    const turf4 = await Turf.create({
      ...
      city: 'Mumbai',
      area: 'Bandra West',
      mapsLink: 'https://maps.app.goo.gl/seedTurf4',
    ...
    const turf5 = await Turf.create({
      ...
      city: 'Delhi',
      area: 'Dwarka',
      mapsLink: 'https://maps.app.goo.gl/seedTurf5',
    ...
    const turf6 = await Turf.create({
      ...
      city: 'Delhi',
      area: 'Vasant Kunj',
      mapsLink: 'https://maps.app.goo.gl/seedTurf6',
